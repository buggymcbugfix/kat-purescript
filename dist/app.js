...
(function(exports) {
  ...
  var SelectAnswer = (function () {
      function SelectAnswer(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SelectAnswer.create = function (value0) {
          return function (value1) {
              return new SelectAnswer(value0, value1);
          };
      };
      return SelectAnswer;
  })();
  var Replay = (function () {
      function Replay(value0) {
          this.value0 = value0;
      };
      Replay.create = function (value0) {
          return new Replay(value0);
      };
      return Replay;
  })();
  var GoToNext = (function () {
      function GoToNext(value0) {
          this.value0 = value0;
      };
      GoToNext.create = function (value0) {
          return new GoToNext(value0);
      };
      return GoToNext;
  })();
  var Correct = (function () {
      function Correct(value0) {
          this.value0 = value0;
      };
      Correct.create = function (value0) {
          return new Correct(value0);
      };
      return Correct;
  })();
  var Incorrect = (function () {
      function Incorrect(value0) {
          this.value0 = value0;
      };
      Incorrect.create = function (value0) {
          return new Incorrect(value0);
      };
      return Incorrect;
  })();
  var vowelGroups = [ A.value, E.value, I.value, O.value, U.value ];
  var ui = function (challenges1) {
      var render = function (state) {
          var replayButton = Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Replay.create)), Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("btn btn-success")) ])([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("replay") ]) ]);
          var message = (function () {
              if (state.answerGiven instanceof Data_Maybe.Nothing) {
                  return Halogen_HTML_Elements.div([  ])([  ]);
              };
              if (state.answerGiven instanceof Data_Maybe.Just && state.answerGiven.value0 instanceof Correct) {
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("card border-success mb-3")) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("card-body text-success")) ])([ Halogen_HTML_Elements.h2([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("card-title")) ])([ Halogen_HTML_Core.text("Well done!") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(GoToNext.create)), Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("btn btn-success")) ])([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("Next") ]) ]) ]) ]);
              };
              if (state.answerGiven instanceof Data_Maybe.Just && state.answerGiven.value0 instanceof Incorrect) {
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("card border-danger mb-3")) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("card-body text-danger")) ])([ Halogen_HTML_Elements.h2([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("card-title")) ])([ Halogen_HTML_Core.text("Oh noes!") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(GoToNext.create)), Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("btn btn-danger")) ])([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("Next") ]) ]) ]) ]);
              };
              throw new Error("Failed pattern match at Main line 139, column 19 - line 168, column 18: " + [ state.answerGiven.constructor.name ]);
          })();
          var choices = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("list-group")) ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_Array.cons(state.current.correctAnswer)(Data_Array_NonEmpty.toArray(state.current.incorrectAnswers)))(function (ans) {
              return Halogen_HTML_Elements.button((function () {
                  if (state.answerGiven instanceof Data_Maybe.Nothing) {
                      return [ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SelectAnswer.create(ans.spelling))), Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("list-group-item list-group-item-action")) ];
                  };
                  if (state.answerGiven instanceof Data_Maybe.Just && state.answerGiven.value0 instanceof Correct) {
                      return [ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Replay.create)), (function () {
                          var $20 = ans.spelling === state.answerGiven.value0.value0;
                          if ($20) {
                              return Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("list-group-item list-group-item-action-success disabled"));
                          };
                          return Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("list-group-item disabled"));
                      })() ];
                  };
                  if (state.answerGiven instanceof Data_Maybe.Just && state.answerGiven.value0 instanceof Incorrect) {
                      return [ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Replay.create)), (function () {
                          var $23 = ans.spelling === state.answerGiven.value0.value0;
                          if ($23) {
                              return Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("list-group-item list-group-item-action-danger disabled"));
                          };
                          return Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("list-group-item disabled"));
                      })() ];
                  };
                  throw new Error("Failed pattern match at Main line 118, column 20 - line 134, column 24: " + [ state.answerGiven.constructor.name ]);
              })())([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text(ans.spelling) ]) ]);
          }));
          var audio = Halogen_HTML_Elements.audio([ Halogen_HTML_Properties.ref(Data_Newtype.wrap(Halogen_Query_InputF.newtypeRefLabel)("audio")), Halogen_HTML_Properties.src(state.current.correctAnswer.pronunciation), Halogen_HTML_Properties.controls(false), Halogen_HTML_Properties.autoplay(true) ])([  ]);
          if (state.finished) {
              return Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("End.") ]);
          };
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("container")) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("root")) ])([ replayButton, audio, choices, message ]) ]);
      };
      var initialState = Data_Function["const"]({
          results: [  ],
          current: Data_Array_NonEmpty.head(challenges1),
          answerGiven: Data_Maybe.Nothing.value,
          todo: Data_Array_NonEmpty.tail(challenges1),
          finished: false
      });
      var $$eval = function (v) {
          if (v instanceof Replay) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(Data_Newtype.wrap(Halogen_Query_InputF.newtypeRefLabel)("audio")))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      var v2 = Data_Functor.map(Data_Maybe.functorMaybe)(Web_HTML_HTMLAudioElement.toHTMLMediaElement)(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Web_HTML_HTMLAudioElement.fromHTMLElement)(v1));
                      if (v2 instanceof Data_Maybe.Just) {
                          return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML_HTMLMediaElement.play(v2.value0));
                      };
                      if (v2 instanceof Data_Maybe.Nothing) {
                          return Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("No audio ref found"));
                      };
                      throw new Error("Failed pattern match at Main line 173, column 7 - line 179, column 7: " + [ v2.constructor.name ]);
                  })())(function () {
          ...
          if (v instanceof SelectAnswer) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var result = (function () {
                      var $32 = v.value0 === st.current.correctAnswer.spelling;
                      if ($32) {
                          return new Correct(v.value0);
                      };
                      return new Incorrect(v.value0);
                  })();
                  var $33 = {};
                  for (var $34 in st) {
                  ...
                  $33.answerGiven = new Data_Maybe.Just(result);
                  $33.results = Data_Array.cons({
                      result: result,
                      vowelGroup: st.current.vowelGroup
                  })(st.results);
                  return $33;
              }))(function (v1) {
          ...
          if (v instanceof GoToNext) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var v1 = Data_Array.uncons(st.todo);
                  if (v1 instanceof Data_Maybe.Just) {
                      var $39 = {};
                      for (var $40 in st) {
                      ...
                      $39.current = v1.value0.head;
                      $39.todo = v1.value0.tail;
                      $39.answerGiven = Data_Maybe.Nothing.value;
                      return $39;
                  };
                  if (v1 instanceof Data_Maybe.Nothing) {
                      var $45 = {};
                  ...
                  throw new Error("Failed pattern match at Main line 190, column 9 - line 192, column 44: " + [ v1.constructor.name ]);
              }))(function (v1) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          throw new Error("Failed pattern match at Main line 170, column 5 - line 170, column 57: " + [ v.constructor.name ]);
      };
  ...
  var genericVowelGroup = new Data_Generic_Rep.Generic(function (x) {
      if (x instanceof A) {
      ...
      throw new Error("Failed pattern match at Main line 41, column 8 - line 41, column 58: " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var showVowelGroup = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericVowelGroup)(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
      return "A";
  ...
  var eqVowelGroup = new Data_Eq.Eq(function (x) {
      return function (y) {
  ...
  var challenges = (function () {
      var x = Data_Array_NonEmpty.singleton({
          correctAnswer: {
              spelling: "A",
              pronunciation: "assets/audio/ka\u026al-kyle-Chloe-1.wav"
          },
          incorrectAnswers: Data_Semigroup.append(Data_Array_NonEmpty_Internal.semigroupNonEmptyArray)(Data_Array_NonEmpty.singleton({
              spelling: "B",
              pronunciation: ""
      ...
      return Data_Semigroup.append(Data_Array_NonEmpty_Internal.semigroupNonEmptyArray)(x)(x);
  })();
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(ui(challenges))(Data_Unit.unit)(v))(function (v1) {
  ...
  exports["O"] = O;
  exports["U"] = U;
  exports["vowelGroups"] = vowelGroups;
  ...
  exports["eqVowelGroup"] = eqVowelGroup;
  exports["genericVowelGroup"] = genericVowelGroup;
  exports["showVowelGroup"] = showVowelGroup;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
},{}]},{},[1]);
